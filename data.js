...
window.DASHBOARD_DATA = {
  ...
  tongQuan: [
    { ten: "Tổng số earned media", target: 23, actual: 22, donVi: "bài", note: "Cập nhật 29/6 — Cộng tổng: Dư luận 18 (đủ chỉ tiêu tuyến) + KOC Hoàng Không Sao 4 clip TikTok T6 = 22/23. (Daily 30Shine tách theo dõi riêng ở tab Daily, không tính vào đây).", nguon: "Live đa kênh" },
    { ten: "Tổng reach thu về (EARNED · organic)", target: 1625000, actual: 411863, donVi: "reach", note: "Cập nhật 1/7 — CHỈ EARNED/ORGANIC: Daily 30Shine 39.139 + Dư luận ORGANIC 78.097 (Threads 78.068 + FB organic chết ~29) + KOC Hoàng TikTok 294.627. ⚠️ ĐÃ TÁCH phần ADS ra khỏi earned: dư luận ads (Meta reach gộp 333K) + Daily WC Argen ads ~2,6M → xem card 'Dư luận: organic vs ads'. Daily & KOC giữ số 22/6 (chưa pull lại).", nguon: "Live đa kênh" },
    ...
    { ten: "CPM dư luận (ads)", target: 20, actual: 9.0, donVi: "K (đạt khi ≤)", note: "Meta API 1/7 (tới hôm nay) — 2 camp Dư Luận (TK Chương 671545627449956): blended ₫9.013 (chi 4,17M / 462.919 hiển thị). Tách: camp Reach ₫4.648 (reach 257K, 9 đơn) · camp Tương tác ₫16.184 (reach 132K, 2.768 tương tác, 9 đơn). RẺ nửa target 20K. ⚠️ Chi 4,17/10M (41,7%) — còn dư 5,83M. ⭐ Halo: CPM demand giảm −41% kỳ dư luận scale (phần lớn do WC hết + scale; dư luận ước ~5%).", nguon: "Meta API (verify 1/7)", thapTotHon: true },
  ...
  duLuanAds: {
    ky: "1/6–1/7/2026 (tới hôm nay)",
    nguon: "Meta Ads API · TK Chương (671545627449956) · verify 1/7",
    tongChi: 4171995, reachGop: 388808, cpmGop: 9013, tongTuongTac: 2768, tongMua: 18, budget: 10000000,
    campaigns: [
      { ten: "ALL · Tương tác · Dư Luận · Chương", loai: "Engagement", spend: 2834407, reach: 132095, impr: 175138, cpm: 16184, freq: 1.33, eng: 2768, mua: 9, dailyBudget: 200000 },
      { ten: "ALL · Reach · Dư Luận · Chương", loai: "Awareness", spend: 1337588, reach: 256713, impr: 287781, cpm: 4648, freq: null, eng: null, mua: 9, dailyBudget: 200000 },
    ],
    posts: [
    ...
    note: "CHỐT THÁNG (Meta API 1/7, kỳ 1–30/6). Đã chi 3,93M / budget 10M = 39,3% (DƯ 6,07M — CPM rẻ nhưng chưa tiêu hết tiền → reach paid hụt target). CPM blended 9.711đ — RẺ nửa target 20K. Camp Reach ăn đứt: CPM 4.783 vs Tương tác 16.184 (×3,4). Dư luận tự ra 18 đơn (9+9). reachGop 333K = cộng thô 2 camp (overlap → unique thấp hơn); hiển thị gộp 405.129. ⭐ HALO: khi dư luận scale (W3–W4), CPM tuyến demand giảm 18,1K→10,6K (−41%) NHƯNG phần lớn do WC kết thúc + scale; phần quy cho dư luận ước ~5%. Cần holdout để chốt chính xác. Bảng 'posts' là breakdown CŨ 1–15/6.",
  },
  ...
  dailyPosts: {
    ...
    tongOrg: 39139, tongAds: 2597476, tongTong: 2636615, tongReact: 354, tongCmt: 37, tongShare: 15,
    note: "Quy ước: rOrg = reach organic (view 'Lượt xem' = proxy); rAds = reach do quảng cáo; Tổng = organic + ads. Bài ngon sẽ vít ads + CTA ăn theo sóng → cột ads để theo dõi tiền bỏ ra phủ thêm bao nhiêu. Tổng earned (tab Tổng quan) CHỈ tính organic. Bài WC 'Anh em Argen': organic 2.524 + ads ~2,6M.",
    list: [
      { ten: "Tour du lịch 45′ — không cần nghỉ phép, không cần đi xa", demand: "Tour", rOrg: 1254, rAds: 0, react: 101, cmt: 13, share: 2, url: "https://www.facebook.com/share/p/17njnFn4Cn/" },
      { ten: "Hào quang nhà vô địch — Hoàng Sao 'The GOAT' (250tr)", demand: "Lan toả WC", rOrg: 3087, rAds: 0, react: 67, cmt: 4, share: 4, url: "https://www.facebook.com/share/p/18mW3X2VMm/" },
      { ten: "Thức khuya xem WC — gội/massage hồi sức 45′", demand: "Nghỉ trưa", rOrg: 28974, rAds: 0, react: 22, cmt: 16, share: 3, url: "https://www.facebook.com/share/p/14ixGifgi3g/" },
      { ten: "Stíp Jobs VN gội đầu sau tan làm — xoá hói, tóc bồng", demand: "Tan làm", rOrg: 961, rAds: 0, react: 4, cmt: 0, share: 1, url: "https://www.facebook.com/share/p/1JQmWKnd7v/" },
      { ten: "Anh em Argen ăn mừng Hattrick WC — căn hộ 45′ 🏆 (vít ads + CTA ăn sóng)", demand: "Lan toả WC", rOrg: 2524, rAds: 2597476, react: 134, cmt: 3, share: 2, click: 1039, url: "https://web.facebook.com/share/p/1bCemYE4Nz/" },
