...
window.DASHBOARD_DATA = {
  ...
  snapshots: [
    ...
    { date: "2026-06-29", note: "update số dư luận theo Business Suite/Threads 29/6: 3 bài boost scale (Người xem 166K/68,6K/30K), +4 bài mới; dư luận đủ 15 bài (13 có số + 2 đăng trong ngày, reach chờ verify); tổng reach dư luận 342K/425K (~81%)", metrics: {
      "Tổng số earned media": 19, "Post kênh dư luận": 15,
      "SEO sessions /discovers": 0, "Bài SEO live": 6, "CPA (post gắn ads)": 64, "CPM dư luận (ads)": 8.9 } },
  ],

  /* ---------- 1. TỔNG QUAN — MỤC TIÊU & % ĐẠT ---------- */
  tongQuan: [
    { ten: "Tổng số earned media", target: 23, actual: 19, donVi: "bài", note: "Cập nhật 29/6 — Cộng tổng: Dư luận 15 (6 Threads + 9 FB page) + KOC Hoàng Không Sao 4 clip TikTok T6 = 19/23. (Daily 30Shine tách theo dõi riêng ở tab Daily, không tính vào đây).", nguon: "Live đa kênh" },
    ...
    { ten: "Post kênh dư luận", target: 18, actual: 15, donVi: "bài", note: "Đã lên 15/18 (tới 29/6): Threads 6 (2 @trag.ngyen + 3 @hanoihiddenvibes + 1 @saigon.afterdark) + FB page 9. Người làm: Chương. 13 bài đã có số (Business Suite/Threads); 2 bài còn lại Chương hoàn tất đăng trong ngày 29/6 — reach chờ verify.", nguon: "Mục tiêu" },
